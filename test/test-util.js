...
describe('test util', function() {
	before(function() {
		...
		this.file =
			new filemodel('D:\\开发库\\WebEsh\\05编码\\WebEsh\\2.Web应用程序\\WebEsh.Web\\Static\\js\\lib\\layer\\layer.ext.js', 'D:\\开发库\\WebEsh\\05编码\\WebEsh\\2.Web应用程序\\WebEsh.Web\\Static\\');
	});
	...
	describe('CloudKeyCanRemove', function() {
		...
		it('should return true with combopath and in the start ', function(done) {
			debugger;
			var key = 'Static/js/$$lib/layer/layer.ext.js,common/procopy/procopy.js,common/btnLoading/btnLoading.js,common/verify/verify.js,common/loginPanel/loginPanel.js'
